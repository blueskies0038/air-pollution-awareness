...
def home(request):
    ...
    return render(request, 'core/home.html', {'effects': effects, 'solutions': solutions, 'readmores': readmores,})
...
def info(request):
    ...
    if request.method == "POST":
        ...
        return render(request, 'core/info.html', {'api': api, 'description': description, 'category_color': category_color, 'info': info})